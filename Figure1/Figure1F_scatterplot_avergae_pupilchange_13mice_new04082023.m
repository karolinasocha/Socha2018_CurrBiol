%% Figure 1F edited on 04 August 2023
...
%%
alpha=0.05
main_array_temporal=cell2mat(trials_temporal_mean');
main_array_nasal=cell2mat(trials_nasal_mean');
...
for iAn=1:length(trials_temporal_mean)
    ...
    s2=scatter(100*mean_values_temporal{iAn}, 100*mean_values_nasal{iAn},'o','MarkerFaceColor',colors(iAn,:),'MarkerEdgeColor','k','SizeData', 100);
end
