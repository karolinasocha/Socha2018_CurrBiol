...
axes(ax_pupildynamics_allsessions_plot(iStim))
...
set(ax_pupildynamics_allsessions_plot(iStim),'ytick',[min(ylimitation_areazscored):0.5:max(ylimitation_areazscored)],'xtick',[0,pre_frames,stim_frames,pre_frames+post_frames],'xticklabel',val,...
    'tickdir','out','box','off','layer','top','color','none',...
    'fontsize',14,'ticklength',get(ax_pupildynamics_allsessions_plot(iStim),'ticklength')*4);
