...
stillthresh=1;
perthresh_stationary=0.95;
perthresh=0.05; % was 95% and 40%; 5% to include all movement-related trials
...
% ttest2 mean bootstrapping p-value:  6.96e-01
% ranksum mean bootstrapping p-value:  5.62e-01

% 95% running with 1cm/s
% ttest2 mean bootstrapping p-value:  2.13e-02
% ranksum mean bootstrapping p-value:  6.99e-03

%5% running 1cm/s
%ttest2 mean bootstrapping p-value:  3.04e-01
%ranksum mean bootstrapping p-value:  1.95e-01
%%
...
% kstest2 mean bootstrapping p-value:  7.35e-02
% ttest2 mean bootstrapping p-value:  8.33e-01 p=0.8330
% ranksum mean bootstrapping p-value:  2.20e-01 p=0.22
% signrank mean bootstrapping p-value:  1.51e-08
%%
...
print(gcf,'-dpdf',[filepathanalysis, 'FigureSuppl2Bcorrect_resampling_plot_density_locomotion_5%_bootstrapped.pdf']);
