...
for iAn=1:size(pupil_average,2)
    clear eye_tmp
    clear stims_temp
    clear epochs_temp
%eye_tmp=diam{iAn};
...
set(gca,'ytick',[0:50:100],'yticklabel',[0:.5:1],'xtick',[0:50:100],'xticklabel',[0:.5:1],'tickdir','out','box','off','tickdir','out',...
...
print(gcf,'-dpdf',[filepathanalysis, 'FigureSuppl2Bcorrect_resampling_plot_density_locomotion_bootstr_mm2_13mice.pdf']);
