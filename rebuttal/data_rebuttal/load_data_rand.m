...
expt_name = [path_data, '\SH055_12dir_SF0.08_TF4_5sstim_5sblank_Rand_20tr.mat'];
...
print(gcf,'-dpdf',[filepathanalysis, 'Figure_randomized_SHexpr.pdf']);
print(gcf,'-dpng',[filepathanalysis, 'Figure_randomized_SHexpr.png']);
%%
...
box off
axis tight
title(sprintf('randomized sequence'))

set(gcf,'paperunits','centimeters','papersize' ,[21,29.7],'color','w','paperposition',[0,0,21,29.7],'inverthardcopy','off');
filepathanalysis='G:\mousebox\code\mouselab\users\karolina\FiguresPaper2023\rebuttal\data_rebuttal\'
print(gcf,'-dpdf',[filepathanalysis, 'Figure_RAWTRACE_randomized_SHexpr.pdf']);
print(gcf,'-dpng',[filepathanalysis, 'Figure_RAWTRACE_randomized_SHexpr.png']);
