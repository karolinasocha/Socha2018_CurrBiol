...
print(gcf,'-dpng',[filepathanalysis, 'Figure_fixedsequence_SHexpr.png']);
%%
...
box off
axis tight
title(sprintf('fixed sequence'))

set(gcf,'paperunits','centimeters','papersize' ,[21,29.7],'color','w','paperposition',[0,0,21,29.7],'inverthardcopy','off');
filepathanalysis='G:\mousebox\code\mouselab\users\karolina\FiguresPaper2023\rebuttal\data_rebuttal\'
print(gcf,'-dpdf',[filepathanalysis, 'Figure_RAWTRACE_fixedsequence_SHexpr.pdf']);
print(gcf,'-dpdf',[filepathanalysis, 'Figure_RAWTRACE_fixedsequence_SHexpr.png']);
