...
for iAn=1:length(av_median_diam_epochs_reordered)
    ...
    av_median_diam_stims_reordered_entire{iAn}, trials_median_diam_stims_reordered_entire{iAn}]=calculate_average_over_epoch_times(expt2{iAn}, av_median_diam_stims_reordered{iAn}, trials_median_diam_stims_reordered{iAn}, nsec_starts, nsec_ends);
    ...
    av_prct_diam_stims_reordered_entire{iAn}, trials_prct_diam_stims_reordered_entire{iAn}]=calculate_average_over_epoch_times(expt2{iAn}, av_prct_diam_stims_reordered{iAn}, trials_prct_diam_stims_reordered{iAn}, nsec_starts, nsec_ends);
...
for iAn=1:length(av_raw_diam_stims_reordered_entire)
    ...
    data_trials_offset=trials_raw_diam_stims_reordered_middle{iAn};
    ...
    data_trials_offset=trials_prct_diam_stims_reordered_middle{iAn};
    ...
    data_trials_offset=trials_median_diam_stims_reordered_middle{iAn};
